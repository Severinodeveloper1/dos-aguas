...
@section('content')
    ...
    <main class="max-w-container-max mx-auto px-margin-edge py-20 font-body" x-data="{
        ...
        <h1 class="font-headline text-3xl md:text-4xl font-bold mb-12 text-center uppercase">{{ __('messages.cart.title') }}
        </h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div class="lg:col-span-8 space-y-6">
                    <div class="border border-outline-variant/10 bg-[#161616] p-6">
                        ...
                        <div
                            class="hidden md:grid grid-cols-12 pb-4 border-b border-outline-variant/10 text-xs font-label-caps text-outline font-bold">
                            ...
                            <template x-for="(item, idx) in cart" :key="item.variantId">
                                <div class="grid grid-cols-1 md:grid-cols-12 items-center py-6 gap-4">
                                    ...
                                    <div class="col-span-6 flex items-center gap-4">
                                        <div
                                            class="w-16 h-20 bg-surface-container flex-shrink-0 border border-outline-variant/5">
                                        ...
                                        <div>
                                            <h4 class="font-headline font-bold text-sm">
                                                <a :href="'/productos/' + item.slug"
                                                    class="hover:text-primary transition-colors" x-text="item.name"></a>
                                            </h4>
                                    ...
                                    <div class="col-span-2 text-center text-xs text-on-surface-variant font-bold font-body">
                                        <span
                                            class="md:hidden text-outline uppercase mr-2 font-bold">{{ __('messages.product.weight') }}:</span>
                                    ...
                                    <div class="col-span-2 flex justify-center items-center">
                                        <div
                                            class="flex items-center border border-outline-variant/30 px-3 py-1.5 gap-4 font-body select-none text-xs">
                                            <button type="button" @click="updateQty(item, item.qty - 1)"
                                                class="hover:text-primary font-bold">-</button>
                                    ...
                                    <div class="col-span-2 text-right text-xs font-bold text-secondary font-body">
                                        <span
                                            class="md:hidden text-outline uppercase mr-2 font-bold">{{ __('messages.cart.total') }}:</span>
