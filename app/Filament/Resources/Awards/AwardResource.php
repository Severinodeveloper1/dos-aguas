...
use App\Filament\Resources\Awards\Tables\AwardTable;
...
class AwardResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Premios y Reconocimientos';
    
    protected static ?string $pluralModelLabel = 'Premios y Reconocimientos';
    ...
    {
        return AwardTable::configure($table);
    }
